...
| ----------- | ---------------- | ------------------ | -------- |
| 1.19        | 5.0.0-dev >=1563 | Yes                | [1.3.1](https://github.com/maxsupermanhd/meteor-villager-roller/releases/download/latest/villager-roller-1.3.1+mc1.19-build.33.jar) |
